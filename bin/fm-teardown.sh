...
# The backlog row is filed Done in the step AFTER this teardown, so between the
# rm above and that filing the row looks exactly like work claimed but never
