...
# because it lacks mutation authority, and another session may be actively
# draining it. It still runs fm-guard.sh directly with non-mutating advisory
# text, so the same alarms surface without repair commands.
