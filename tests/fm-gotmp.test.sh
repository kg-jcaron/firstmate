...
make_fake_root() {
  ...
  # fm-supervision-lib.sh: teardown sources it to record the completion-pending
  # marker that keeps the claimed-but-never-dispatched guard quiet between this
  # cleanup and the backlog row being filed.
